...
public class SearchGuitarInventory {

  public static void main(String[] args) {
    Inventory inventory = new Inventory();
    initializeInventory(inventory);

    GuitarSpec whatYouLike = new GuitarSpec(Builder.FENDER, "Stratocastor", Type.ELECTRIC, 6, Wood.ALDER, Wood.ALDER);
    ArrayList<Guitar> matchingGuitars = inventory.search(whatYouLike);
    if(!matchingGuitars.isEmpty()){
      ...
      System.out.println("Sorry we don't have any guitar matching with your specs requirement right now.");
    }
  }
